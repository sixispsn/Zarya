...
_ACTIVE_BASELINE = NormativeBaseline(
    ...
    documents=(
        ...
        NormativeDocument(
            ...
            effective_date="2023-09-01",
            verified_on="2026-09-03",
            source_url="https://protect.gost.ru/TrList/85",
        ...
        NormativeDocument(
            ...
            verified_on="2026-09-03",
            source_url="https://docs.cntd.ru/document/573741260",
        ...
        NormativeDocument(
            ...
            verified_on="2026-09-03",
            source_url="https://84.mchs.gov.ru/deyatelnost/press-centr/novosti/5812737",
        ...
        NormativeDocument(
            ...
            local_scope="Предоставленная локальная копия.",
        ),
        NormativeDocument(
