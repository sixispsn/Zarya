...
class FireCabinetNormative:
    ...
    require_different_risers: при 2 струях — из ПК на разных стояках
        (п. 6.2.2: коридор >10 м, ПК ≥2 → по одному на разных стояках/опусках).
    placement_mode: одна сторона / две противоположные.
    coverage_scheme: трактовка длины/ширины (на будущее).
    """
    required_jets: int
    require_different_risers: bool
    placement_mode: PlacementMode
    coverage_scheme: CoverageScheme = CoverageScheme.LONG_WALLS
