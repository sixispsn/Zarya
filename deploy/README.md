...
Схема: домен → Caddy (HTTPS и пароль) → FastAPI. Проекты, загруженные планы АР
и подтверждённые привязки К1/К2 хранятся в именованном Docker-томе
`zarya_projects` и не пропадают при обновлении контейнера.
